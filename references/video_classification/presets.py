import torch
from my_torchvision.transforms import transforms
from transforms import ConvertBCHWtoCBHW, VideoColorJitter
...
class VideoClassificationPresetTrain:
    def __init__(
        ...
        *,
        ...
        # enable Video Color Jitter
        trans.append(VideoColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.05, p=0.5)) 
