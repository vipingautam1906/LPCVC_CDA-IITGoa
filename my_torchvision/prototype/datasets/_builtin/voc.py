...
from my_torchvision.datasets import VOCDetection
from my_torchvision.prototype.datasets.utils import Dataset, EncodedImage, HttpResource, OnlineResource
from my_torchvision.prototype.datasets.utils._internal import (
    getitem,
    hint_sharding,
    hint_shuffling,
...
from my_torchvision.tv_tensors import BoundingBoxes
