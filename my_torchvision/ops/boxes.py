...
from my_torchvision.extension import _assert_has_ops
...
def batched_nms(
    ...
    if boxes.numel() > (4000 if boxes.device.type == "cpu" else 100_000) and not my_torchvision._is_tracing():
