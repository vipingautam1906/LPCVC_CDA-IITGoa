...
import torch
from my_torchvision.io import _probe_video_from_file, _read_video_from_file, read_video, read_video_timestamps
...
class VideoClips:
    ...
    def get_clip(self, idx: int) -> tuple[torch.Tensor, torch.Tensor, dict[str, Any], int]:
        ...
        from my_torchvision import get_video_backend
